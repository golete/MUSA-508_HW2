...
# NOTE: Do we need this here? I recoded some of these variables, and I think
# it might make sense to do the variable selection right before the regression
# step for each iteration. -EE
varsA <- c('price',
...
# TODO: Decide what outliers to exclude, e.g.
# "24-bedroom" former farm: https://www.realtor.com/realestateandhomes-detail/12525-Quicksilver-Rd_Longmont_CO_80501_M18542-29229
