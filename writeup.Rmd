...
```{r predicted vs. observed price: by price, fig.width=10, fig.height=4}
...
```{r MAPE by neighborhood: table, fig.width=10}
...
#   kable_classic(full_width = F)
```
```{r MAPE by neighborhood: map, fig.width=10}
